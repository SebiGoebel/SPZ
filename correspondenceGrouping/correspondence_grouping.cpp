...
int main(int argc, char *argv[])
{
  ...
  //
  //  Compute Descriptor for keypoints with SHOT
  //
  ...
  //
  //  Compute Descriptor for keypoints with FPFH
  //
  /*
  pcl::FPFHEstimationOMP<pcl::PointXYZ, pcl::Normal, pcl::FPFHSignature33> descr_est;
  descr_est.setRadiusSearch(descr_rad_);
  // pcl::search::KdTree<pcl::PointXYZ>::Ptr tree_fpfh(new pcl::search::KdTree<pcl::PointXYZ>);
  // descr_est.setSearchMethod(tree_fpfh);
